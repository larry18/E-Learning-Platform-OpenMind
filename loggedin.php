  ...
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
	...
	<div class="card-container">
		<div class="card bg-light mb-3" style="max-width: 18rem;">
	  		...
	  		<div class="card-body">
	    		<ul style="list-style-type:circle">
					...
					<li><a class="card-text" href="loggedin/computer_science_C#.php">C#</a></li>
					<li><a class="card-text" href="loggedin/computer_science_rust.php">Rust</a></li>
	    		</ul>
	  		</div>
		</div>
		...
		<div class="card bg-light mb-3" style="max-width: 18rem;">
	  		...
	  		<div class="card-body">
	    		<ul style="list-style-type:circle">
				<li><a class="card-text" href="loggedin/language_nepali.php">Nepali</a></li>
				<li><a class="card-text" href="loggedin/language_arabic.php">Arabic</a><br></li>
					...
					<li><a class="card-text" href="loggedin/language_chinese.php">Chinese</a></li>
		...
		<div class="card bg-light mb-3" style="max-width: 18rem;">
	  		...
	  		<div class="card-body">
	    		<ul style="list-style-type:circle">
					...
					<li><a class="card-text" href="loggedin/blockchain_technology.php">Blockchain Technology</a></li>
					<li><a class="card-text" href="loggedin/iot_robotics.php">IoT & Robotics</a></li>
	    		</ul>
	  		</div>
		</div>
